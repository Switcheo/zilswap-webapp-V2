...
import { Blockchain, getEvmChainIDs } from 'app/utils';
...
export const EthRpcUrl = {
  ...
  [Blockchain.Zilliqa]: "https://api.zilliqa.com/",
}
  ...
  switch (network) {
    case Network.MainNet:
      return {
        ...
        [Blockchain.Zilliqa]: {
          chainId: `0x${getEvmChainIDs(network).get(Blockchain.Zilliqa)!.toString(16)}`,
          chainName: "Zilliqa Network",
          nativeCurrency: {
            name: "Zilliqa Token",
            symbol: "ZIL",
            decimals: 12
          },
          rpcUrls: [EthRpcUrl[network][Blockchain.Zilliqa]],
          blockExplorerUrls: ["https://otterscan.zilliqa.com/"]
        },
      }
