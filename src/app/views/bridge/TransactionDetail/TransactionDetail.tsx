...
import {
  Blockchain,
  getExplorerLink, getExplorerSite,
  hexToRGBA,
  trimValue,
  truncate,
  truncateAddress,
...
import { ReactComponent as StraightLine } from 'app/views/bridge/NewBridge/components/ConfirmTransfer/straight-line.svg'
import { ReactComponent as WavyLine } from 'app/views/bridge/NewBridge/wavy-line.svg'
                    ...
                    <Text className={cls(classes.link, classes.progressInfo)}>
                      {currentBridgeTx.destinationTxHash ? (
                        <Link
                          ...
                          rel="noopener noreferrer"
                          target="_blank"
                          href={getCarbonExplorerLink(currentBridgeTx.destinationTxHash)}
                        >
